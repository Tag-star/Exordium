export default function SocialLinks() {
  return (
    <div className="flex gap-4 mt-4">
      <a href="https://facebook.com/PLACEHOLDER" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-cream-100/70 hover:text-wood-300">
      ...
      <a href="https://instagram.com/PLACEHOLDER" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-cream-100/70 hover:text-wood-300">
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <a href="https://tiktok.com/@PLACEHOLDER" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-cream-100/70 hover:text-wood-300">
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
